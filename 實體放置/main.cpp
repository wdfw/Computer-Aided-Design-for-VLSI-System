...
int main(int argc, char* argv[]){
    ...
    while(1){
        ...
        if(best_state.aspect_ratio<MinAspectRatio || best_state.aspect_ratio>MaxAspectRatio){
            ...
            swap(temp_area.first,temp_area.second) ;
            cout << "Optimal Area : " << temp_area.first*temp_area.second << " " << temp_area << "\n" ;
            cout << "Optimal Aspect Ratio : " << best_state.aspect_ratio <<"\n" ;
            cout << "Optimal Cost : " << lowest_cost << "\n" ;
            //cout << "Optimal Sequence : " << best_state <<"\n"; 
